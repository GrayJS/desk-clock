...
当前稳定版本：[`v0.6.9`](https://github.com/GrayJS/desk-clock/releases/latest)
...
- Windows 托盘图标支持分别配置单击和双击动作，可上传 PNG、JPG 或 WebP 自定义图标
...
- **Windows 托盘**：分别配置托盘图标的单击和双击动作，可选开始/暂停、重置、切换模式、置顶、打开设置或无操作；还可上传自定义托盘图标
...
- 专注记录、当前目标、时长、主题、语言、窗口尺寸、置顶、通知和托盘偏好均保存在本机 `localStorage`
